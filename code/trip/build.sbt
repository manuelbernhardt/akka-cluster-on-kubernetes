...
lazy val library =
  new {
    ...
    val akkaBootstrapManagement    = "com.lightbend.akka.management" %% "akka-management-cluster-bootstrap" % "0.17.0"
    val akkaBootstrapDiscoveryK8   = "com.lightbend.akka.discovery"  %% "akka-discovery-kubernetes-api"     % "0.17.0"
    val akkaCluster                = "com.typesafe.akka"             %% "akka-cluster"                      % "2.5.14"
    val akkaClusterCustomDowning   = "com.github.TanUkkii007"        %% "akka-cluster-custom-downing"       % "0.0.12"
    val akkaClusterSharding        = "com.typesafe.akka"             %% "akka-cluster-sharding"             % "2.5.14"
